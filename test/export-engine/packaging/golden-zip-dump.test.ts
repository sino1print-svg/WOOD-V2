 ...
 * golden-zips-external.mts` invokes this test with `GOLDEN_ZIP_DUMP_DIR`
 * set (a TypeScript verification script, not the pure packaging core, may
 * shell out).
 */
